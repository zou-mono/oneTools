...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 5, 600, 691))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 600, 235, 28))
        ...
        self.txt_resolution = QtWidgets.QLineEdit(self.layoutWidget4)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(330, 600, 252, 28))
        ...
        self.txt_tilesize = QtWidgets.QLineEdit(self.layoutWidget5)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(11, 13, 581, 29))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget6)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.rbtn_onlyHandle = QtWidgets.QRadioButton(self.layoutWidget6)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        ...
        self.rbtn_spiderAndHandle = QtWidgets.QRadioButton(self.layoutWidget6)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        ...
        self.rbtn_onlySpider = QtWidgets.QRadioButton(self.layoutWidget6)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        ...
        self.label_2.setGeometry(QtCore.QRect(11, 361, 81, 23))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.txt_originX = QtWidgets.QTextEdit(self.frame)
        self.txt_originX.setEnabled(True)
        self.txt_originX.setGeometry(QtCore.QRect(99, 361, 191, 29))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.label_3.setGeometry(QtCore.QRect(321, 361, 81, 23))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.txt_originY = QtWidgets.QTextEdit(self.frame)
        self.txt_originY.setEnabled(True)
        self.txt_originY.setGeometry(QtCore.QRect(409, 361, 181, 29))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.label_10.setGeometry(QtCore.QRect(11, 321, 72, 23))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.cmb_level = QtWidgets.QComboBox(self.frame)
        self.cmb_level.setGeometry(QtCore.QRect(99, 321, 87, 26))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.cmb_level.setFont(font)
        self.cmb_level.setObjectName("cmb_level")
        self.label_11 = QtWidgets.QLabel(self.frame)
        self.label_11.setGeometry(QtCore.QRect(11, 165, 187, 23))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        ...
        self.label_12.setGeometry(QtCore.QRect(11, 238, 85, 23))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(11, 195, 581, 36))
        self.layoutWidget7.setObjectName("layoutWidget7")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget7)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.txt_infoPath = QtWidgets.QLineEdit(self.layoutWidget7)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(9)
        ...
        self.btn_infoDialog = QtWidgets.QPushButton(self.layoutWidget7)
        ...
        self.layoutWidget8.setGeometry(QtCore.QRect(11, 268, 361, 36))
        self.layoutWidget8.setObjectName("layoutWidget8")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.layoutWidget8)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.txt_imageFolderPath = QtWidgets.QLineEdit(self.layoutWidget8)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(9)
        ...
        self.btn_tilesDialog = QtWidgets.QPushButton(self.layoutWidget8)
        ...
        self.layoutWidget9.setGeometry(QtCore.QRect(11, 51, 581, 107))
        ...
        self.txt_address = QtWidgets.QTextEdit(self.layoutWidget9)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.btn_obtain = QtWidgets.QPushButton(self.layoutWidget9)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        ...
        self.textEdit.setGeometry(QtCore.QRect(10, 700, 601, 181))
