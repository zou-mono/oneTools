...
a = Analysis(['frmMain.py','frmCoordTransform.py','frmTileMap.py','frmVectorMap.py','icons_rc.py',
             ...
             binaries=[('C:\\Users\\mono_ws\\miniconda3\\envs\\gdal3.2\\Library\\lib\\gdalplugins','Library\\lib\\gdalplugins'),
                       ('C:\\Users\\mono_ws\\miniconda3\\envs\\gdal3.2\\Library\\bin\\FileGDBAPI.dll', '.')],
             datas=[('C:\\Users\\mono_ws\\miniconda3\\envs\\gdal3.2\\Library\\share\\proj','Library\\share\\proj')],
