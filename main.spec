...
a = Analysis(['frmMain.py','frmCoordTransform.py','frmTileMap.py','frmVectorMap.py','icons_rc.py',
             ...
             binaries=[('C:\\Users\\mono-office-laptop\\miniconda3\\envs\\gdal3.2\\Library\\lib\\gdalplugins','Library\\lib\\gdalplugins'),
                       ('C:\\Users\\mono-office-laptop\\miniconda3\\envs\\gdal3.2\\Library\\bin\\FileGDBAPI.dll', 'Library\\bin')],
             datas=[('C:\\Users\\mono-office-laptop\\miniconda3\\envs\\gdal3.2\\Library\\share\\proj','Library\\share\\proj')],
             hiddenimports=[],
             hookspath=[],
