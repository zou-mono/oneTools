...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 511, 715))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_1.setText(_translate("Dialog", "加载批处理影像服务地址文件"))
        self.label_2.setText(_translate("Dialog", "加载批处理瓦片地址文件"))
        self.btn_addRow.setToolTip(_translate("Dialog", "增加服务项"))
        self.btn_removeRow.setToolTip(_translate("Dialog", "删除服务项"))
        self.btn_obtainMeta.setToolTip(_translate("Dialog", "获取元数据"))
        self.btn_saveMetaFile.setToolTip(_translate("Dialog", "获取元数据"))
