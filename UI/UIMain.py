...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/EditingAdjustmentModifyLink32.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_coordTransform.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/AnimationCreateGroup32.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_vectorCrawler.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/RasterImageAnalysisDifference32.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_imageCrawler.setIcon(icon2)
